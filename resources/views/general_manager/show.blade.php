...
{{--                                    <a href="{{'editar',$id_listing)}}" class="color-bg tolt" data-microtip-position="left" data-tooltip="Edit"><i--}}
{{--                                            class="fal fa-edit"></i></a>--}}
...
{{--                                        <div class="geodir-category-location clearfix"><a href="#"> {{$customer['email']}}</a></div>--}}
{{--                                    </div>--}}
{{--                                @endforeach--}}
{{--                            </div>--}}
{{--                        </div>--}}
